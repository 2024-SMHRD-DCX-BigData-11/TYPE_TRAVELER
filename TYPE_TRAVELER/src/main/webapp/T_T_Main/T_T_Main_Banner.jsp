...
<div id="myPageModal" style="display: none;">
    <div id="myPageContent">
        ...
        <form id="profileForm" action="${pageContext.request.contextPath}/UpdateCon" method="post" onsubmit="return validatePassword()">
            ...
            <input type="text" id="user_name" name="user_name" value="${sessionScope.memberInfo.user_name}" required>
            
            <label for="user_mbti">MBTI</label>
            <input type="text" id="user_mbti" name="user_mbti" value="${sessionScope.memberInfo.user_mbti}" required>
